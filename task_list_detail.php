...
unset($_SESSION['success'], $_SESSION['error'], $_SESSION['success_type']);
$show_submission_modal = ($success_type === 'submit_task');
  ...
  <div class="dashboard-shell">
    ...
    <div
      ...
      <div class="success-modal__card">
        <h2 id="submission-modal-title">The task is submitted, wait for approval</h2>
...
<script>
  (function() {
    ...
    if (submissionOk) {
      submissionOk.addEventListener('click', closeSubmissionModal);
    }
